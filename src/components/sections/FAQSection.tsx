      ...
      <div>
        ...
        <Accordion variant="splitted" className="bg-transparent">
          {t.items.map((item, idx) => (
            <AccordionItem key={idx} aria-label={item.q} title={item.q} subtitle="" className="bg-white/70 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800 rounded-xl">
